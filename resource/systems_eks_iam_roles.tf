        ...
        Statement = [
            {
                ...
                Principal = {
                    ...
                    AWS = ["arn:aws:iam::${data.aws_caller_identity.caller.account_id}:user/dev-systems", 
                            "arn:aws:iam::${data.aws_caller_identity.caller.account_id}:user/rihongo", 
                            "arn:aws:iam::${data.aws_caller_identity.caller.account_id}:user/minsoub@bithumbsystems.com", 
                            "arn:aws:iam::${data.aws_caller_identity.caller.account_id}:user/rihongo@bithumbsystems.com", 
